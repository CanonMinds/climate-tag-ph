            ...
            for row in csv_reader:
                if line_count == 0:
                    ...
                    if row[0] != "":
                        ...
                        adaptation_dev_finance_commitment_2019=row[7]
                        adaptation_dev_finance_commitment_current=row[8]
                        mitigation_dev_finance_commitment_2019=row[9]
                        mitigation_dev_finance_commitment_current=row[10]
                        overlap_commitment_2019=row[11]
                        overlap_commitment_current=row[12]
                        climate_dev_finance_commitment_2019=row[13]
                        climate_dev_finance_commitment_current=row[14]
                        ...
                        country_code_value = InitialModel.objects.get(country_code=int(country_code))
                ...
                logging.info("PROCESSED -'%s' LINES. OECD DATA IMPORT SUCCESS." % (int(line_count)-1))
